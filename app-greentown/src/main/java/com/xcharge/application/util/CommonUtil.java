...
public class CommonUtil {
    ...
    public static String encrypt(String content, String secretKey, String secretIv) throws Exception {
        if (content == null) {
            return "";
        }
    ...
    public static String decrypt(String sSrc, String secretKey, String secretIv) throws Exception {
        byte[] raw = secretKey.getBytes(StandardCharsets.UTF_8);
        SecretKeySpec skeySpec = new SecretKeySpec(raw, "AES");
    ...
    public static String sign(String value, String sigSecret) throws Exception {
        return getHmacMd5Str(sigSecret, value);
